...
#define PLAYBACK_PREFILL_BYTES 1600 /* jitter buffer: gom ~100ms (8kHz/16-bit) truoc khi phat */
...
struct private_data
{
    ...
    uint8_t *playbackData;
    switch_mutex_t *playbackMutex;
    int playbackActive;
    SpeexResamplerState *playbackResampler;
    int playbackResamplerInRate;
    int rtp_packets;
};
